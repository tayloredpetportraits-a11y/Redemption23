      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <section id="upsell-section" className="space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-zinc-400">
              Get all {upsellImages.length} additional images for just $9
            </p>
          </div>
              ...
              >
                ...
                {!isPaid && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="text-white/40 text-6xl font-bold transform -rotate-12">
                      LOCKED
                    </div>
                  </div>
                )}
          ...
          {!isPaid ? (
            <div className="text-center">
              ...
              >
                Unlock All {upsellImages.length} Images for $9
              </button>
            </div>
          ) : (
            <motion.div
          ...
          >
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                >
                  {paymentLoading ? 'Processing...' : 'Pay $9'}
                </button>
              </div>
            </motion.div>
          </motion.div>
